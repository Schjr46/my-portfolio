    ...
    <main className="h-screen flex justify-center items-center bg-transparent bg">
      <div className="flex flex-col gap-20 max-w-screen-xl w-full px-8 md:flex-row">
        <div className="flex flex-col justify-center items-start w-full md:w-3/4">
          <h1 className="text-4xl font-bold text-white">Hello, My name is Truong!</h1>
          <p className="text-white">
            ...
            . I often take frontend tasks for those pet projects so I'd love to
            spend more time with backend tasks.
          </p>
          <div className="text-white pt-20">
    <p> Here are what i have learn through out the years at university(including my personal and group projects)</p>
          </div>
